...
import com.videostore.jpacontroller.GenresFacade;
...
@ManagedBean(name = "genresController")
@SessionScoped
public class GenresController implements Serializable {
    ...
    @EJB
    private com.videostore.jpacontroller.GenresFacade ejbFacade;
    ...
    public String create() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("GenresCreated"));
    ...
    public String update() {
        try {
            ...
            JsfUtil.addSuccessMessage(ResourceBundle.getBundle("/Bundle").getString("GenresUpdated"));
            return "View";
        } catch (Exception e) {
            JsfUtil.addErrorMessage(e, ResourceBundle.getBundle("/Bundle").getString("PersistenceErrorOccured"));
            return null;
